...
export function MobileBottomNav() {
  ...
  return (
    <nav className="fixed bottom-4 left-4 right-4 z-50 flex items-center justify-around rounded-lg border border-border bg-background/95 px-4 py-3 shadow-lg backdrop-blur-sm md:hidden">
