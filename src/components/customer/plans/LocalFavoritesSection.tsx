        ...
        <div className="grid gap-8 lg:grid-cols-2 lg:gap-12">
          ...
          <div className="flex items-center justify-center">
            <div className="relative h-80 w-full overflow-hidden rounded-2xl sm:h-96">
              ...
              <div className="hidden h-full w-full flex-col items-center justify-center rounded-2xl border-2 border-dashed border-border bg-gradient-to-br from-accent to-accent/50 p-8">
