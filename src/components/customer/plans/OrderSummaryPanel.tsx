...
export function OrderSummaryPanel({
  ...
  return (
    <div className="space-y-4">
      <div
        className={cn(
          "sticky top-6 rounded-lg bg-white border border-gray-100 shadow-xl p-8 transition-all duration-300",
        )}
      >
        ...
        {isLoading ? (
          ...
          <div className="space-y-4">
            ...
            <Button
              ...
              className={cn(
                "w-full h-14 rounded-lg font-black text-primary-foreground shadow-lg mt-6 text-base group transition-all",
      ...
      {/* Trust Promise */}
      <div className="rounded-lg bg-destructive/10 p-4 flex items-start gap-4">
