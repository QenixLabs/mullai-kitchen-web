          ...
          <div className="mb-8 overflow-hidden rounded-2xl border border-border bg-accent shadow-md shadow-primary/10">
            <div className="flex flex-col gap-4 p-5 sm:flex-row sm:items-center sm:gap-6 sm:p-6">
              ...
              <button
                ...
                className="group inline-flex shrink-0 items-center gap-2 rounded-2xl bg-primary px-5 py-2.5 text-sm font-bold text-primary-foreground shadow-md shadow-primary/20 transition-all duration-300 hover:bg-primary/90 hover:shadow-lg hover:shadow-primary/30 active:scale-[0.97]"
              >
