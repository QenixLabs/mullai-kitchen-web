        ...
        {isLoading ? (
          ...
          <div className="space-y-4">
            ...
            {balance !== null && balance > 0 && (
              <div className="flex items-start gap-2 rounded-2xl border border-blue-50 bg-blue-50 p-3">
            ...
            {/* Zero Balance Info */}
            {balance === 0 && (
              <div className="flex items-start gap-2 rounded-2xl border border-primary/20 bg-primary/10 p-3">
            ...
            {balance !== null && balance >= 1000 && (
              <div className="flex items-start gap-2 rounded-2xl border border-emerald-100 bg-emerald-50 p-3">
