    ...
    >
      ...
      >
        <div className="flex items-center gap-3">
          ...
          >
            <Wallet className={cn("h-5 w-5", hasBalance ? "text-emerald-600" : "text-gray-500")} />
          </div>
          <div>
      ...
      <div className="p-6">
        {isLoading ? (
          ...
          <div className="space-y-4">
            ...
            {/* Zero Balance Info */}
            {balance === 0 && (
              <div className="flex items-start gap-2 rounded-xl border border-orange-100 bg-orange-50 p-3">
