          ...
          <div className="relative">
            ...
            {showFilterDropdown && (
              <motion.div
                ...
                className="absolute right-0 top-full z-10 mt-2 w-48 overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-lg"
              >
                <div className="p-1">
          ...
          {sortedTransactions.map((tx, index) => {
            ...
            return (
              <motion.div
                ...
                className="flex items-start gap-4 rounded-2xl border border-border bg-background p-4 shadow-sm hover:shadow-md transition-shadow"
              >
                {/* Icon */}
                <div
                  className={cn(
