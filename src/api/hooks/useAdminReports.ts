...
import type { IOperationsReportQuery, IOperationsReportItem, IFinancialReportQuery, IFinancialReportResponse, IRevenueAnalyticsQuery, IRevenueAnalyticsResponse } from '@/api/types/admin.types';
...
export function useRevenueAnalytics(params: IRevenueAnalyticsQuery) {
  return useQuery<IRevenueAnalyticsResponse>({
    queryKey: adminReportKeys.revenueAnalytics(params),
