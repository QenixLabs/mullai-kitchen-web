                  ...
                  <div className="relative h-full bg-white/5 backdrop-blur-xl rounded-2xl sm:rounded-3xl overflow-hidden border border-white/10 hover:border-[#D4A574]/30 transition-all duration-300">
                    ...
                    <div className="relative h-48 sm:h-52 overflow-hidden">
                      ...
                      <div className="absolute top-3 left-3 sm:top-4 sm:left-4 flex flex-col gap-1.5 sm:gap-2">
                        {item.popular && (
                          <motion.div
                            initial={{ scale: 0 }}
                            animate={{ scale: 1 }}
                            className="flex items-center gap-1 bg-gradient-to-r from-[#39070F] to-[#5a0f1a] text-white text-[10px] sm:text-xs font-semibold px-2 sm:px-3 py-1 sm:py-1.5 rounded-full shadow-lg shadow-[#39070F]/30"
                          >
                        ...
                        <div className={cn(
                          ...
                          {item.veg ? <Leaf className="h-3 w-3 sm:h-3.5 sm:w-3.5" /> : <Flame className="h-3 w-3 sm:h-3.5 sm:w-3.5" />}
                      ...
                      <motion.button
                        ...
                        whileTap={{ scale: 0.9 }}
                        className="absolute bottom-3 right-3 sm:bottom-4 sm:right-4 w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-r from-[#39070F] to-[#5a0f1a] rounded-full shadow-lg shadow-[#39070F]/30 flex items-center justify-center text-white opacity-100 sm:opacity-0 sm:group-hover:opacity-100 transition-all duration-300 hover:shadow-xl"
                      >
                    ...
                    <div className="p-4 sm:p-5">
                      <h3 className="text-base sm:text-lg font-bold text-white mb-1 sm:mb-2">{item.name}</h3>
                      <p className="text-xs sm:text-sm text-white/60 mb-3 sm:mb-4 line-clamp-2">{item.description}</p>
                      ...
                      <div className="flex items-center gap-2 sm:gap-4 text-[10px] sm:text-xs text-white/50 mb-3 sm:mb-4">
                        ...
                        <span className="text-white/40 hidden sm:inline">({item.reviews})</span>
                      </div>

                      <div className="flex items-center justify-between">
                        <div className="flex items-baseline gap-1">
                          <span className="text-xl sm:text-2xl font-bold text-white">₹{item.price}</span>
                          <span className="text-xs sm:text-sm text-white/50">/meal</span>
                        </div>
                        <Button
                          size="sm"
                          className="rounded-full bg-gradient-to-r from-[#D4A574] to-[#c49a6a] hover:from-[#e8c4a0] hover:to-[#D4A574] text-[#39070F] text-xs sm:text-sm font-semibold shadow-lg shadow-[#D4A574]/20 transition-all hover:scale-[1.02] active:scale-[0.98] px-3 sm:px-4 py-1 sm:py-2 h-auto"
                        >
                          Order
                        </Button>
                      </div>
