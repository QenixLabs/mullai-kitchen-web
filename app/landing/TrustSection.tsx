...
import { MapPin, Shield, Leaf, Clock, Award, Heart, ChefHat, Star, Users, Sparkles } from "lucide-react";
  ...
  return (
    ...
    >
      <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-linear-to-br from-[#D4A574] to-[#c49a6a] shrink-0">
        <Icon className="h-6 w-6 text-[#39070F]" />
      </div>
      <div>
        <div className="flex items-baseline gap-1">
          ...
          {suffix && <span className="text-lg font-semibold text-[#D4A574]">{suffix}</span>}
        </div>
...
export function TrustSection() {
  ...
  return (
    <section ref={ref} className="relative py-24 overflow-hidden">
      ...
      <div className="absolute inset-0 bg-linear-to-b from-[#1a0509] via-[#39070F] to-[#1a0509]" />
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        >
          <div className="w-80 h-80 bg-[#39070F]/20 rounded-full blur-[100px]" />
        </motion.div>
      ...
      <div className="relative mx-auto max-w-[1400px] px-4 sm:px-6 lg:px-8 xl:px-12">
        ...
        >
          <motion.div
            variants={fadeInUp}
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-linear-to-r from-[#D4A574]/20 to-[#39070F]/20 border border-[#D4A574]/30 mb-6"
          >
            <ChefHat className="h-4 w-4 text-[#D4A574]" />
            <span className="text-sm font-semibold text-white tracking-wide">Chennai&apos;s Trusted Cloud Kitchen</span>
          </motion.div>
        ...
        >
          {trustSignals.map((signal, index) => (
            ...
            >
              {/* Hover Glow */}
              <div className="absolute -inset-1 bg-linear-to-r from-[#D4A574]/10 to-[#39070F]/10 rounded-2xl blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
              ...
              <div className="relative bg-white/5 backdrop-blur-xl rounded-2xl p-6 border border-white/10 hover:border-[#D4A574]/30 transition-all duration-300">
                {/* Gradient Top Border */}
                <div className="absolute top-0 left-0 right-0 h-1 bg-linear-to-r from-[#39070F] via-[#D4A574] to-[#39070F] opacity-80 rounded-t-2xl" />
        ...
        >
          {/* Glow Effect */}
          <div className="absolute -inset-2 bg-linear-to-r from-[#D4A574]/10 to-[#39070F]/10 rounded-3xl blur-2xl opacity-50" />

          <div className="relative bg-white/5 backdrop-blur-xl rounded-3xl p-8 border border-white/10">
            {/* Gradient Top Border */}
            <div className="absolute top-0 left-0 right-0 h-1 bg-linear-to-r from-[#39070F] via-[#D4A574] to-[#39070F] rounded-t-3xl" />
            ...
            <div className="grid lg:grid-cols-2 gap-8 items-center">
              ...
              <div>
                <div className="flex items-center gap-3 mb-5">
                  <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-[#D4A574] to-[#c49a6a]">
                    <MapPin className="h-6 w-6 text-[#39070F]" />
                  </div>
                  <h3 className="text-2xl font-bold text-white">Delivering Across Chennai</h3>
                </div>
                ...
                <div className="flex flex-wrap gap-2 mb-6">
                  {chennaiAreas.map((area) => (
                    <span
                      key={area}
                      className="px-4 py-2 rounded-full bg-white/10 text-white/80 text-sm border border-white/10 hover:bg-white/20 hover:border-[#D4A574]/30 transition-all cursor-pointer"
                    >
                      {area}
                    </span>
                  ))}
                ...
                <div className="flex items-center gap-6">
                  <div className="flex items-center gap-3 px-4 py-2 rounded-full bg-linear-to-r from-[#39070F] to-[#5a0f1a]">
                    <Users className="h-5 w-5 text-[#D4A574]" />
                    <span className="text-white font-semibold"><span className="text-[#D4A574] font-bold">2,000+</span> Happy Customers</span>
                  </div>
                </div>
              </div>
              ...
              <div className="relative h-72 rounded-2xl overflow-hidden">
                ...
                <div className="absolute bottom-5 left-5 right-5">
                  <p className="text-white font-semibold text-lg">Professional chefs preparing your meals</p>
