...
const faqs = [
  {
    ...
    answer:
      "You can pause or cancel your subscription anytime from your dashboard before 9 PM the previous day. Just go to your subscription settings and select the dates you want to pause. No questions asked!",
    category: "orders",
  },
  {
    question: "What areas do you deliver to?",
    answer:
      "We currently deliver to most areas in Chennai including Anna Nagar, T. Nagar, Adyar, Mylapore, Velachery, Nungambakkam, and 10+ more neighborhoods. Enter your pincode on our homepage to check availability in your area.",
    category: "delivery",
  },
  {
    question: "Can I customize my meals?",
    answer:
      "Yes! You can customize spice levels, portion sizes, and dietary preferences. Our Executive Plus plan offers advanced customization options including specific dish preferences and ingredient exclusions.",
    category: "orders",
  },
  {
    question: "How fresh is the food?",
    answer:
      "All meals are prepared fresh daily using high-quality ingredients sourced from local markets. We use temperature-controlled packaging to ensure your food stays hot and fresh during delivery. No preservatives or frozen items ever!",
    category: "orders",
  },
  {
    question: "What is your delivery timing?",
    answer:
      "We offer delivery slots for Breakfast (7-9 AM), Lunch (12-2 PM), and Dinner (7-9 PM). You can choose your preferred slot when setting up your subscription. We guarantee delivery within the selected time window.",
    category: "delivery",
  },
  {
    question: "How does the payment work?",
    answer:
      "We offer secure payment through Zoho Payments. You can pay via UPI, credit/debit cards, or net banking. For subscriptions, we use a wallet system where we reserve the amount and only charge after successful delivery confirmation.",
    category: "payment",
  },
  {
    question: "What if I'm not home during delivery?",
    answer:
      "If you're not home, our delivery partner will try to contact you. We can leave the meal with security or a neighbor if instructed. For gated communities, we can coordinate with security. The meal stays fresh for up to 2 hours in our insulated packaging.",
    category: "delivery",
  },
  {
    question: "Do you offer refunds?",
    answer:
      "Yes! If you cancel before the 9 PM cutoff, you get full credit to your wallet. For any quality issues, contact our support within 24 hours of delivery and we'll process a refund or replacement immediately.",
    category: "payment",
  },
];
