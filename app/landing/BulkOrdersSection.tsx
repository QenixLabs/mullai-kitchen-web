...
import { Building2, Users, Utensils, Calendar, Mail, Phone, ArrowRight } from "lucide-react";
...
const features = [
  {
    ...
    description: "Tailored meal plans for your office teams, from daily lunches to special events."
  },
  {
    icon: Users,
    title: "Bulk Orders",
    description: "Perfect for family gatherings, celebrations, and community events."
  },
  {
    icon: Utensils,
    title: "Custom Menus",
  ...
  return (
    <section ref={ref} className="py-24 bg-[#1a0509] relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-0 right-0 w-full h-full bg-linear-to-b from-[#39070F]/40 to-transparent" />
        <div className="absolute top-1/2 -right-1/4 w-[500px] h-[500px] bg-[#D4A574]/10 rounded-full blur-[120px]" />
        <div className="absolute -bottom-1/4 -left-1/4 w-[500px] h-[500px] bg-[#39070F]/30 rounded-full blur-[120px]" />
      </div>
          ...
          >
            <div className="space-y-4">
              ...
              >
                ...
                <span className="text-xs font-bold text-white/80 uppercase tracking-widest">Corporate & Events</span>
              </motion.div>
            ...
            >
              Whether it&apos;s a daily corporate lunch arrangement or a one-time grand celebration, 
              Mullai provides authentic, high-quality South Indian catering services tailored to your scale.
            </motion.p>
            ...
            <div className="grid gap-4 mt-8">
              {features.map((feature, index) => (
                ...
                >
                  <div className="shrink-0 w-14 h-14 rounded-xl bg-gradient-to-br from-[#39070F] to-[#5a0f1a] flex items-center justify-center border border-white/10 group-hover:scale-110 transition-transform">
            ...
            >
              <Button 
                onClick={() => window.location.href = 'mailto:founder@mullai.net?subject=Corporate/Bulk Order Inquiry'}
          ...
          >
              ...
              <div className="absolute bottom-6 left-6 right-6 bg-white/10 backdrop-blur-xl p-8 rounded-3xl shadow-xl border border-white/10">
                <div className="flex items-center justify-between mb-6">
                  <div className="flex -space-x-3">
                    {[1, 2, 3, 4].map((i) => (
                      <div key={i} className="w-12 h-12 rounded-full border-2 border-[#1a0509] bg-gray-200 overflow-hidden">
                  ...
                  <div className="text-right">
                    <p className="text-xs text-white/40 uppercase tracking-widest mb-1">Trusted by</p>
                    <p className="text-lg font-bold text-white">10+ Corporates</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <p className="text text-white/70 italic leading-relaxed">
                    "Exceptional service for our annual event! The food was fresh and stayed hot throughout."
                  </p>
                </div>
              </div>
            </div>
            ...
            >
              <div className="flex flex-col items-center">
                <Calendar className="w-10 h-10 mb-2 text-[#39070F]" />
                <p className="text-[10px] font-bold text-[#39070F]/40 uppercase tracking-widest">Book for</p>
                <p className="text-2xl font-black text-[#39070F]">2026</p>
              </div>
            </motion.div>
          </motion.div>
        </div>
