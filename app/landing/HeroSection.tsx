  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col justify-center">
        ...
        <p className="text-[10px] sm:text-xs text-white/60 mt-0.5 leading-none">
          {label}
        </p>
      </div>
    </motion.div>
      ...
      <div className="relative z-10 mx-auto max-w-[1400px] px-4 sm:px-6 lg:px-8 xl:px-12 pt-24 sm:pt-28 md:pt-32 pb-16 sm:pb-20">
        <div className="grid lg:grid-cols-[1.3fr_1fr] gap-8 lg:gap-16 items-center min-h-[50vh] sm:min-h-[60vh] md:min-h-[65vh] lg:min-h-[70vh]">
          ...
          >
            ...
            >
              Cloud kitchen serving fresh, preservative-free South Indian
              delicacies. Subscribe for daily breakfast, lunch, or dinner
              ...
              <div className="relative bg-white/95 backdrop-blur-xl rounded-2xl p-6 border border-white/50 shadow-2xl overflow-hidden">
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  ...
                  <Button
                    ...
                    className="h-12 sm:h-14 px-6 sm:px-8 bg-gradient-to-r from-primary to-[#5a0f1a] hover:from-[#4a0a15] hover:to-[#6b1020] text-white font-semibold rounded-xl shadow-lg shadow-primary/30 disabled:opacity-50 transition-all hover:scale-[1.02] active:scale-[0.98]"
                  >
                    {isChecking ? (
                      <motion.div
                        animate={{ rotate: 360 }}
              ...
              <div className="relative bg-white/95 backdrop-blur-xl rounded-3xl overflow-hidden shadow-2xl border border-white/50">
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Button className="h-12 px-6 bg-gradient-to-r from-primary to-[#5a0f1a] hover:from-[#4a0a15] hover:to-[#6b1020] text-white font-semibold rounded-full shadow-lg shadow-primary/30 transition-all hover:scale-[1.02] active:scale-[0.98]">
